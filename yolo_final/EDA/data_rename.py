...
def rename_and_move_json_files(source_directory, destination_directory):
    #source path = path + "/" + label
    #dest path = path + "/" + new_label
    # 만약 대상 디렉터리가 없다면 생성
...
# 파일이 포함된 소스 디렉터리 경로
source_directory_path = r"E:\urban_datasets\general_rail\labels_kor"
# 새로운 폴더에 저장할 대상 디렉터리 경로
destination_directory_path = r"E:\urban_datasets\general_rail\labels"
